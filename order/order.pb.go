...
func (x *OrderStatusUpdate) GetOldStatus() string {
	if x != nil {
		return x.OldStatus
	}
	return ""
...
func (x *OrderStatusUpdate) GetNewStatus() string {
	if x != nil {
		return x.NewStatus
	}
	return ""
...
const file_proto_order_order_proto_rawDesc = "" +
	...
	"\border_id\x18\x01 \x01(\tR\aorderId\"\xc1\x01\n" +
	"\x11OrderStatusUpdate\x12\x19\n" +
	"\border_id\x18\x01 \x01(\tR\aorderId\x12\x1d\n" +
	"\n" +
	"old_status\x18\x02 \x01(\tR\toldStatus\x12\x1d\n" +
	"\n" +
	"new_status\x18\x03 \x01(\tR\tnewStatus\x12\x18\n" +
	"\amessage\x18\x04 \x01(\tR\amessage\x129\n" +
	"\n" +
	"updated_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAt2b\n" +
	"\x14OrderTrackingService\x12J\n" +
	"\x17SubscribeToOrderUpdates\x12\x13.order.OrderRequest\x1a\x18.order.OrderStatusUpdate0\x01B/Z-github.com/IK-akx/ap2-generated/order;orderpbb\x06proto3"
